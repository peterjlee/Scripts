/*	Fork of ROI_Color_Coder.ijm IJ BAR: https://github.com/tferr/Scripts#scripts
	...
	v220706 Table friendly version  f1: updated colors and replaced binary[-]Check with toWhiteBGBinary f2-3: Updated color functions.
 */
macro "ROI Color Coder with Scaled Labels" {
	macroL = "BAR_ROI_Color_Coder_Unit-Scaled_Labels_ASC_v220706-f3.ijm";
