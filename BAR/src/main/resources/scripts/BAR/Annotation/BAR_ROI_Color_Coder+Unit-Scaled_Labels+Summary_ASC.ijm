/*	Fork of ROI_Color_Coder.ijm IJ BAR: https://github.com/tferr/Scripts#scripts
	...
	v230517b:	Keeps focus in selected image for coloring. Fixes saved settings for summary output.
 ...
 */
	...
	*/
	...
	Added the ability to added user-text to summary and data preview in summary dialog.
	 ...
	 + v180326 Adds "Manual input" option to outliers (use this option for sigma>3).
